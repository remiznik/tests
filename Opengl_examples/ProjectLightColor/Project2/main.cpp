...
int main()
{
	...
	Program lightingShader("shaders/lighting.frag", "shaders/lighting.vs");
	Program lampShader("shaders/lamp.frag", "shaders/lamp.vs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(objectColorLoc, 1.0f, .5f, .31f);
		...
		glm::mat4 projection = glm::perspective(camera.zoom() / 10, (GLfloat)WIDTH / (GLfloat)HEIGHT, 0.01f, 100.0f);
